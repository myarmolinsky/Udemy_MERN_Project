...
export const login = (email, password) => async dispatch => {
  //we are taking in email and password as parameters instead of as an object because there are only 2 parameters as opposed to for register where there would be 3
  const config = {
    headers: {
      "Content-Type": "application/json"
    }
